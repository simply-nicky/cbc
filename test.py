...
B12_PREFIX = 'b12_2'
B12_NUM = 135
B12_DET_POS = np.array([115.29697554, 129.16733852, 99.88790367]) #mm
...
if __name__ == "__main__":
    ...
    parser.add_argument('--tol', type=float, nargs=2, default=[[0.025, 0.025, 0.075], 0.12], help='Refinement tolerance: det_pos, rec_basis')
